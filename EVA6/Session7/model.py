...
class Net(nn.Module):
    def __init__(self, drop=0.025):
        ...
        self.convblock1 = nn.Sequential(
            nn.Conv2d(
                in_channels=3, out_channels=32, kernel_size=(3, 3), padding=1, bias=False
            ),  # Input: 32x32x3 | Output: 32x32x32 | RF: 3x3
            nn.BatchNorm2d(32),
            nn.ReLU(),
            nn.Dropout(drop),
            nn.Conv2d(
                in_channels=32, out_channels=32, kernel_size=(3, 3), padding=1, bias=False
        ...
        self.convblock2 = nn.Sequential(
            nn.Conv2d(
                in_channels=32, out_channels=64, kernel_size=(3, 3), padding=1, bias=False
            ),  # Input: 16x16x32 | Output: 16x16x64 | RF: 11x11
            nn.BatchNorm2d(64),
            nn.ReLU(),
            nn.Dropout(drop),
        )
        ...
        self.convblock3 = nn.Sequential(
            ...
            nn.Dropout(drop),
            nn.Conv2d(
                in_channels=128, out_channels=32, kernel_size=(1, 1), bias=False
            ),  # Input: 8x8x128 | Output: 8x8x32 | RF: 23x23
            nn.BatchNorm2d(32),
            nn.ReLU(),
            nn.Dropout(drop),
        )
        ...
        self.transblock3 = nn.Sequential(
            nn.Conv2d(
                ...
                dilation=2,
                bias=False,
            ),  # Input: 8x8x128 | Output: 6x6x32 | RF: 39x39
            nn.Conv2d(
                in_channels=32,
                out_channels=32,
                kernel_size=(3, 3),
                ...
                dilation=2,
                bias=False,
            ),  # Input: 6x6x32 | Output: 4x4x32 | RF: 55x55
            nn.BatchNorm2d(32),
            nn.ReLU(),
            nn.Dropout(drop),
        )
        ...
        self.convblock4 = nn.Sequential(
            nn.Conv2d(
                in_channels=32, out_channels=32, kernel_size=(3, 3), padding=1, bias=False
            ),  # Input: 4x4x32 | Output: 4x4x32 | RF: 63x63
            nn.ReLU(),
            nn.Conv2d(
                in_channels=32, out_channels=10, kernel_size=(3, 3), padding=1, bias=False
            ),  # Input: 4x4x32 | Output: 4x4x10 | RF: 71x71
        )
